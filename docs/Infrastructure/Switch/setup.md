...
First and foremost - make sure you have a serial terminal software installed. Common examples include `screen` and `minicom` - if you used the init script in this repository, then you should have already installed `minicom`.
